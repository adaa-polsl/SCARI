...
public class ActionTests {
	...
	protected void dumpData(ExampleSet exampleSet, ActionRuleSet actions) throws IOException {
		...
		fw.write("Induction measure used: " + ((ClassificationMeasure)params.getInductionMeasure()).getName() + System.lineSeparator());
		fw.write("Pruning measure used: " + ((ClassificationMeasure)params.getPruningMeasure()).getName() + System.lineSeparator());
