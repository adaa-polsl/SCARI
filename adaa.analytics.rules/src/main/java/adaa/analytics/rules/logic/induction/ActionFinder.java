...
*/
	...
	private double calculateActionQuality(Covering covering, IQualityMeasure measure) {
		return ((ClassificationMeasure)measure).calculate(covering);
	}

	public void prune(Rule rule_, final ExampleSet trainSet) {
		...
		this.classificationFinder.prune(source, trainSet);
		this.classificationFinder.prune(target, trainSet);
