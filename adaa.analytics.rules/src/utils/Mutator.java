...
public class Mutator {
    ...
    public ExampleSet mutateExamples(ExampleSet splitted, ActionMetaTable metaTable, String sourceClass, String targetClass, ActionRuleSet usedRecommendations, ExampleSet trainSet) throws OperatorException {
